    ...
    public partial class TestControlsAutoComplete : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (true)
            {
                ...
                GLTextBoxAutoComplete gla = new GLTextBoxAutoComplete("ACTB", new Rectangle(4, 4, 200, 25));
                gla.TabOrder = taborder++;
                gla.TextAreaBackColor = Color.Yellow;
                gla.ShowWaitButton = true;
                ...
                wbo.Click = (ss,ee) => { gla.ShowWaitButton = !gla.ShowWaitButton; };
                pn.Add(wbo);
