...
namespace GLOFC.GL4.Shaders.Vertex
{
    ...
    public class GLPLVertexScaleLookatConfigurable : GLShaderPipelineComponentShadersBase
    {
        /// <summary>
        /// Constructor
        ///  Input
        ...
        public GLPLVertexScaleLookatConfigurable(bool rotatetoviewer = false, bool rotateelevation = true, int commontransformuniform = 0, bool texcoords = false, bool generateworldpos = false,
                                                  bool useeyedistance = true)
        {
...
void main(void)
{
    ...
    if ( mc.Perspective && rotate )       // reverified after much work 21/7/21
    {
