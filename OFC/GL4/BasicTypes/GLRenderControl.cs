...
namespace OFC.GL4
{
    ...
    public class GLRenderControl 
    {
        ...
        static public GLRenderControl DefaultStartState()
        {
            return new GLRenderControl(PrimitiveType.Points)        // Set the default state we want to be in at start
            {
...
//                Scissors = null,                
        ...
        static public GLRenderControl AllNull()         // used at startup, everything needs to be null so we apply all when we apply the DefaultStateState
        {
