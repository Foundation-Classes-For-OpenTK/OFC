...
namespace GLOFC.GL4.Textures
{
    ...
    public class GLTexture2D : GLTextureBase 
    {
        ...
        /// <summary>
        /// Construct a texture from a subset of a bitmap
        /// </summary>
        /// <param name="bmp">Bitmap</param>
        /// <param name="area">Rectangle to take of bitmap</param>
        /// <param name="internalformat">Internal format, see InternalFormat in Texture base class</param>/// 
        /// <param name="bmpmipmaplevels">Mip map levels in bitmap</param>
        /// <param name="wantedmipmaplevels">Mip map levels wanted in texture</param>
        /// <param name="alignment">Load into texture with this alignment, it bitmap is smaller than texture. Only for mipmaplevel = 0.  Use only for autogenerated mipmaps or no mip maps</param>
        public GLTexture2D(Bitmap bmp, Rectangle area, SizedInternalFormat internalformat, int bmpmipmaplevels = 1,
                            int wantedmipmaplevels = 1, ContentAlignment alignment = ContentAlignment.TopLeft)
        {
            var bmppart = bmp.Clone(area, bmp.PixelFormat);
            CreateLoadBitmap(bmppart, internalformat, bmpmipmaplevels, wantedmipmaplevels, false, alignment);
            bmppart.Dispose();
        }

        /// <summary>
        /// Construct a texture from the centre of a bitmap
        /// </summary>
        /// <param name="bmp">Bitmap</param>
        /// <param name="partsize">Size of centre to take</param>
        /// <param name="internalformat">Internal format, see InternalFormat in Texture base class</param>/// 
        /// <param name="bmpmipmaplevels">Mip map levels in bitmap</param>
        /// <param name="wantedmipmaplevels">Mip map levels wanted in texture</param>
        /// <param name="alignment">Load into texture with this alignment, it bitmap is smaller than texture. Only for mipmaplevel = 0.  Use only for autogenerated mipmaps or no mip maps</param>
        public GLTexture2D(Bitmap bmp, SizeF partsize, SizedInternalFormat internalformat, int bmpmipmaplevels = 1,
                            int wantedmipmaplevels = 1, ContentAlignment alignment = ContentAlignment.TopLeft)
        {
            CreateLoadBitmap(bmp, partsize, internalformat, bmpmipmaplevels, wantedmipmaplevels,alignment);
        }
        ...
        /// <summary>
        /// Create and load the centre of a bitmap. You can reload the bitmap, it will create a new Texture if required
        /// </summary>
        /// <param name="bmp">Bitmap to load. A new bitmap with the partsize is made so the texture never owns this</param>
        /// <param name="partsize">Size of centre to take</param>
        /// <param name="internalformat">Internal format, see InternalFormat in Texture base class</param>/// 
        /// <param name="bmpmipmaplevels">Mip map levels in bitmap</param>
        /// <param name="wantedmipmaplevels">Mip map levels wanted in texture</param>
        /// <param name="alignment">Load into texture with this alignment, it bitmap is smaller than texture. Only for mipmaplevel = 0.  Use only for autogenerated mipmaps or no mip maps</param>
        public void CreateLoadBitmap(Bitmap bmp, SizeF partsize, SizedInternalFormat internalformat, int bmpmipmaplevels = 1,
                                                int wantedmipmaplevels = 1, ContentAlignment alignment = ContentAlignment.TopLeft)
        {
            var bmppart = bmp.CloneCentre(partsize);
            CreateLoadBitmap(bmppart, internalformat, bmpmipmaplevels, wantedmipmaplevels, false, alignment);
            bmppart.Dispose();
        }
