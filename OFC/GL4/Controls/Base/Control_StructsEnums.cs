...
namespace GLOFC.GL4.Controls
{
    public abstract partial class GLBaseControl : IDisposable
    {
        ...
        public struct PaddingType
        {
            ...
            public PaddingType(int left, int top, int right, int bottom) { Left = left; Top = top; Right = right; Bottom = bottom; }
            /// <summary> Construct with the same value for all four pads</summary>
            public PaddingType(int pad = 0) { Left = pad; Top = pad; Right = pad; Bottom = pad; }
            ...
            public static bool operator ==(PaddingType l, PaddingType r) { return l.Left == r.Left && l.Right == r.Right && l.Top == r.Top && l.Bottom == r.Bottom; }
            /// <summary> Test for inequality </summary>
            public static bool operator !=(PaddingType l, PaddingType r) { return !(l.Left == r.Left && l.Right == r.Right && l.Top == r.Top && l.Bottom == r.Bottom); }
            /// <summary> Test if equals </summary>
            public override bool Equals(Object other) { return other is PaddingType && this == (PaddingType)other; }
        ...
        public struct MarginType
        {
            ...
            public MarginType(int left, int top, int right, int bottom) { Left = left; Top = top; Right = right; Bottom = bottom; }
            /// <summary> Construct with same value for all four margins</summary>
            public MarginType(int pad = 0) { Left = pad; Top = pad; Right = pad; Bottom = pad; }
            ...
            /// <summary> Test for equality</summary>
            public static bool operator ==(MarginType l, MarginType r) { return l.Left == r.Left && l.Right == r.Right && l.Top == r.Top && l.Bottom == r.Bottom; }
            /// <summary> Test for inequality </summary>
            public static bool operator !=(MarginType l, MarginType r) { return !(l.Left == r.Left && l.Right == r.Right && l.Top == r.Top && l.Bottom == r.Bottom); }
            /// <summary> Test if equals </summary>
            public override bool Equals(Object other) { return other is MarginType && this == (MarginType)other; }
            /// <summary> Get Hash </summary>
            public override int GetHashCode() { return base.GetHashCode(); }
            /// <summary> Get string description </summary>
            public override string ToString() { return $"({Left} {Top} {Right} {Bottom})"; }
