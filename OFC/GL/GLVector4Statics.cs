...
{
    /// <summary>
    /// Static helper functions for Vector4
    /// </summary>
    ...
    public static class GLStaticsVector4
    {
        ...
        /// <summary> Translate array of vectors </summary>
        ...
        /// <summary> Transform array of vectors</summary>
        ...
        /// <summary>Minimum and maximise find on Z </summary>
        ...
        /// <summary>Color array to Vector4 array </summary>
        ...
        /// <summary> Color to vector4 </summary>
        ...
        /// <summary> Given a z position, and a vector from x0 to x1, is there a point on that vector which has the same z?  otherwise return NAN</summary>
        ...
        /// <summary> Given two vectors, and a intercept in z, return vectors </summary>
        ...
        /// <summary>Given two vectors, and a intercept in z, return vectors and tex co-ords </summary>
        ...
        /// <summary> Given an intercept point, return vector between two points </summary>
        ...
        /// <summary> Average points in array </summary>
        ...
        /// <summary> Convert to vector 3 </summary>
        public static Vector3 ToVector3(this Vector4 v)
        {
            return new Vector3(v.X, v.Y, v.Z);
        }

        /// <summary> Output arra of vectors as a string </summary>
