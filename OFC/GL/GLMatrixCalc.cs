...
namespace OFC
{
    ...
    public class GLMatrixCalc
    {
        ...
        // OFC uses the following axis orientation with +z away from us, +x to right, +y upwards.
        ...
        Matrix4 modelaxisflip = Matrix4.CreateScale(new Vector3(1, -1, 1));   // flip y to make y+ up
        ...
        public void CalculateProjectionMatrix(out float znear)
        {
            ...
            ProjectionMatrix = ProjectionMatrix * modelaxisflip;
