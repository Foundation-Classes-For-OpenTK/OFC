...
namespace GLOFC.Controller
{
    ...
    public class Controller3Dd : Controller3DBase
    {
        ...
        protected override float ZoomFactor => (float)PosCamera.ZoomFactor;
        protected override Vector2 CameraDirection => new Vector2((float)PosCamera.CameraDirection.X, (float)PosCamera.CameraDirection.Y);
        protected override float CameraRotation => (float)PosCamera.CameraRotation;
        protected override float ZoomMin => (float)PosCamera.ZoomMin;
        protected override float ZoomMax => (float)PosCamera.ZoomMax;
